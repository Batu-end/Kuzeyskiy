...
5. Under **Privileged Gateway Intents**, enable:
   - ✅ Message Content Intent (**required** — lets the bot auto-play Spotify links pasted into chat)
...
| `/volume <1-100>` | Set volume (applies to the current track instantly) |
...
- Spotify links are resolved to track names via `spotify-url-info`, then played from the matching YouTube result. Very new or obscure tracks may not match perfectly. Try searching by name instead.
